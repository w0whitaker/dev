...
## File structure
The project root (the directory in which this file is located) contains the main 11ty configuration file, the project's `package.json`, and any other configuration files for non-11ty tools, such as linters.

Everything related to generating content is located in the `src/` directory. Further information about what's in them can be found in each directory's `README.md`. The files generated at build time are located in the `_site/` directory. 
